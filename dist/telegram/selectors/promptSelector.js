...
function checkTextIntent(text) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const selector = yield model.call([
            new schema_1.SystemMessage(`Check if the text pertains to an event or occasion: Text: ${text}. Give the output in boolean. If text pertains to an event or any type of occasion, then give the output in boolean 'true' else 'false'. Not 'True' or "False.Like in small letters`),
